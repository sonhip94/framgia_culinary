    ...
    <div class="container full-container" id="server-view">
        <div>
            <div class="result-box">
                    ...
                    <div class="result-headline">
                        <div>
                            <div class="result-container">
                                <h1>{{ trans("sites.topReceiptEvaluate") }}</h1>
                                <div class="desc">
                                    <strong class="text-highlight">{{ $countTopEvaluate }}</strong>
                                    {{ trans("sites.receipt") }}
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-footer">
                                                <div class="recipe-by">
                                                    <a href="{{ route('detail', $item->user->id) }}" target="_blank">
                                                        <img class="circle"
                ...
                <div class="text-center">{{ $topEvaluate->links() }}</div>
            </div>
        </div>
    </div>
@endsection
