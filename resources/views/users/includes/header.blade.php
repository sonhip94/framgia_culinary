                        ...
                        <li>
                            <a href="#">
                                <span class="fa fa-mobile-phone"></span> <span
                                        class="sr-only">{{ trans("appMobile") }}</span>
                            </a>
                        <li><a href="#" target="_blank" rel="nofollow"> <span class="fa fa-facebook-square"></span>
                                <span class="sr-only">{{ trans("fanpage") }}</span>
                            </a>
                        <li><a href="#" target="_blank" rel="nofollow"> <span
                                        class="fa fa-instagram"></span> <span
                                        class="sr-only">{{ trans("instagram") }}</span> </a>
                        <li><a href="#" target="_blank" rel="nofollow"> <span
                                        class="fa fa-youtube-square"></span> <span class="sr-only">{{ trans("youtube") }}</span>
                            </a>
                    </ul>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-main-navbar-collapse-1">
                ...
                <ul class="nomargin list-inline right-wrap navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu login-widget" role="menu">
                            {{ trans('sites.notify') }} ở {{ trans('sites.here') }}
                        </div>
                    </li>
                    <li class="dropdown" style="width:30px">
                        <a href="#" style="border:none;" id="myTabDrop1" class="dropdown-toggle" data-toggle="dropdown">
                            <img id="avatarUser" style="width:100%;border:none;" src="{{ Auth::user()->avatar }}"/> <b class="caret"></b>
                        </a>
